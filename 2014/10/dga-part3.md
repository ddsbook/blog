Title: Building a DGA Classifer: Part 3, Model Selection
...
were mis-classified, with a simliar ratio on the legitimate side. If you
...
legitimate traffic, but we shouldn't think that this will apply to all
domains generated from any DGA. As new domains are observed and new
botnets emerge, this entire process should be repeated with new training
data.
